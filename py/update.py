...
def round_time_to_15min(dt):
    """将时间四舍五入到最近的15分钟，23:45之后的时间都设为23:45"""
    # 确保输入是datetime类型
    ...
    # 如果分钟数会导致小时数增加且当前是23点，则固定为23:45
    if hour == 23 and minute_rounded == 60:
        minute_rounded = 45
...
def process_update_list():
    ...
    # 保存结果
    output_file = PROCESSED_DIR / 'update.xlsx'
